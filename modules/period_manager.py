...
def get_current_period():
    """
    Returns the period dict from settings.PERIODS corresponding to today's date.
    """
...
def update_settings_for_period():
    ...
    Raises RuntimeError if outside defined periods.
    ...
    # Update target balance and period info
